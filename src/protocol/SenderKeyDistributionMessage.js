  ...
  constructor(
    ...
    if (serialized) {
      try {
        ...
        const distributionMessage = MessageProto.Message.SenderKeyDistributionMessage.decode(
          message
        ).toJSON();
      ...
      const message = MessageProto.Message.SenderKeyDistributionMessage.encode(
        MessageProto.Message.SenderKeyDistributionMessage.create({
          id,
          iteration,
          chainKey,
