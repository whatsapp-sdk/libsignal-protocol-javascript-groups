...
const WhisperTextProto = require('../../proto/WhisperText.proto');
...
class SenderKeyMessage extends CiphertextMessage {
  ...
  constructor(
    ...
    if (serialized) {
      ...
      const senderKeyMessage = MessageProto.Message.SenderKeyMessage.decode(message).toJSON();
      ...
      const message = MessageProto.Message.SenderKeyMessage.encode(
        MessageProto.Message.SenderKeyMessage.create({
          id: keyId,
          iteration,
          ciphertext,
        })
  ...
  getSignature(signatureKey, serialized) {
    ...
    const signature = Buffer.from(
      curve.calculateSignature(
        utils.bufferToArrayBuffer(signatureKey),
        utils.bufferToArrayBuffer(serialized)
      )
    );
    return signature;
  }
